import pytest
import json
from model_bakery import baker  # Библиотека фабрики подсвечивается красным
from students.models import Course


@pytest.fixture
def user(django_user_model):
    return django_user_model.objects.creatr_user(username='TestUser', password='1111111')
